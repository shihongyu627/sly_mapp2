<template>
	...
	<view>
		...
		<view v-if="indent == 'all'" class="info-wrap">
			<!-- 银行姓名 -->
			<view class="info-list-cell info-list-con" hover-class="cell-hover" @click="modifyInfo('luodi_bank_name')">
				<text class="cell-tit">银行名称</text>
				<text class="cell-tip ">{{ formData.luodi_bank_name||"请点击输入银行名称" }}</text>
				<text class="cell-more"></text>
			</view>
			<!-- 银行卡号 -->
			<view class="info-list-cell info-list-con" hover-class="cell-hover" @click="modifyInfo('luodi_bank_account')">
				<text class="cell-tit">银行卡号</text>
				<text class="cell-tip">{{ formData.luodi_bank_account||"请点击输入银行卡号" }}</text>
				<text class="cell-more"></text>
			</view>
			<!-- 银行支行 -->
			<view class="info-list-cell info-list-con" hover-class="cell-hover" @click="modifyInfo('luodi_bank_address')">
				<text class="cell-tit">银行支行</text>
				<text class="cell-tip">{{ formData.luodi_bank_address||"请点击输入银行支行" }}</text>
				<text class="cell-more"></text>
			</view>
		</view>
