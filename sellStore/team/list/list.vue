	...
	<view class="order-container" :data-theme="themeStyle">
		<mescroll-uni ref="mescroll" @getData="getListData" top="20rpx">
			<block slot="list">
					...
					<view class="team-list">
						<view class="team-item" v-for="(orderItem, orderIndex) in orderList" :key="orderIndex">
							...
							<view class="team-right">
								<view class="team-content" @click="goUserInfo(orderItem)">
									...
									<view class="team-content-item">
										<view class="team-text">
											关联用户：{{orderItem.member_nickname}}
										</view>
									</view>
									<view class="team-content-item">
								...
								<view class="team-del-box" @click="onClickdelete(orderItem.worker_id)">
									<text class="team-del">
				...
				<block v-else>
					<view>
						<ns-empty :isIndex="!1" text="暂无员工"></ns-empty>
					</view>
				</block>
			</block>
		</mescroll-uni>
...
<script>
	...
	export default {
		...
		methods: {
			...
			joinTeam() {
				console.log(123);
				this.$util.redirectTo('/sellStore/team/create/create');
			},
