	...
	<view class="detail-container" :class="{ 'safe-area': isIphoneX }" :data-theme="themeStyle">
		...
		<view class="address-box">
			<view class="adddress-top">
				...
				<img class='store-tel' src="@/common/img/store_tel.png" mode="aspectFill" @click="makePhone()" />
			</view>
			<view class="address-bottom">
				<view class="address-left">
					...
					<view class="address-content">
						回龙观街道， 融澤嘉园6号楼1单元2305
					</view>
				</view>
				<view class="address-guide">
					<img class='guide-icon' src="@/common/img/store_tel.png" mode="aspectFill" @click="makePhone()" />
		...
		<!-- 选择支付方式弹窗 -->
		<ns-payment ref="choosePaymentPopup" :payMoney="orderData.pay_money" @confirm="orderPay(orderData)">
		</ns-payment>
