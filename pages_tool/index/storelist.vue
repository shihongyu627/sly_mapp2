	...
	<view>
		<view class="search-header">
			<view class="search-box">
				<input class="uni-input" maxlength="50" v-model="inputValue" confirm-type="search" @focus="inputFocus"
					focus @confirm="search()" placeholder="请搜索关键词" />
				<text class="iconfont iconsousuo3" @click="search()"></text>
			</view>
		</view>

		<mescroll-uni ref="mescroll" top='90rpx' @getData="getData" class="member-point">
			<view slot="list">
						...
						<view class="list-content-box">
							...
							<view class="list-content">
								<block v-for="(item, index) in dataList" :key="index">
									<view class="list-item" @click="storeTap(item)">
										<view class="item-box">
											...
											<!-- 	<view class="item-right" @click="selectStore(item.store_id)"><text
													class="iconfont iconright"></text></view> -->
										</view>
									</view>
